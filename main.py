...
#TOKEN - Unique bot identifier, replace this with your code either here or in credentials.py
            ...
            for x in userArray:
                if message.author.id == x.ID:
                    ...
                    if not isAdmin(x):
                        ...
                        try:
                            echoMessage = message.content.split(' ')[1]
                ...
                if message.author.id == x.ID:
                    ...
                    if not isAdmin(x):
                        ...
                        try:
                            ...
                            await message.channel.send("```Usage: $mute followed by the person you'd like to mute followed by the number of minutes"
